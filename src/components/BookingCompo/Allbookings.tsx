...
const Allbookings = () => {
    ...
    return (
        <div className="font-CustomFont my-5 flex flex-col justify-center items-center container">
            <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 mx-auto px-10 gap-3">
                {
