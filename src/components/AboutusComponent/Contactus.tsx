...
<Title name='Get in Touch'/>
        ...
        <div className=" block lg:flex flex-row-reverse font-CustomFont gap-2 py-10 justify-center items-center mx-auto">
...
<div className='w-full lg:max-w-xl px-5 flex flex-col justify-center items-center h-72 bg-gradient-to-r from-[#ebf4f5] to-[#d3f3f1]'>
<h1 className="text-2xl uppercase font-bold">meet us</h1>
<p>
