    ...
    return (
        <div className="font-CustomFont flex flex-col justify-center items-center w-full">
            ...
            <div className="grid grid-cols-2 gap-3 justify-center  mx-auto">
                <Card className="rounded-none w-96 h-52 text-center items-center flex flex-col justify-center hover:bg-sky-100 transition-all duration-300 ">
                ...
                <Card className="rounded-none w-96 h-52  text-center items-center flex flex-col justify-center hover:bg-red-100 transition-all duration-300">
                    <div className="flex gap-1 justify-center items-center">
                ...
                <Card className="rounded-none w-96 h-52 text-center items-center flex flex-col justify-center hover:bg-green-100 transition-all duration-300">
                    <h1>Total booking</h1>
                    <p className="font-CustomFont text-5xl font-bold ">30</p>

                </Card>
                <Card className="rounded-none w-96 h-52 text-center items-center flex flex-col justify-center hover:bg-yellow-100 transition-all duration-300">
                    <h1>Total User</h1>
