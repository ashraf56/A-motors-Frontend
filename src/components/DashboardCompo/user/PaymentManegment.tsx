              ...
              {data?.data?.map((p: any) => (
                <TableRow key={p._id}>
                  ...
                  <TableCell className="font-medium flex gap-3 justify-center   items-center">
                    ...
                    {p.bookingStatus === 'completed' ? <Button size={'sm'} variant={'outline'} className="text-red-500"> Complete Payment </Button> :
                      <Button size={'sm'} variant={'outline'} className="text-red-500" disabled> Complete Payment </Button>
                    }
